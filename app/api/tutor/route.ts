...
export async function POST(req: NextRequest) {
  try {
    const { query, studentName, conceptName, history } = await req.json();
...
- When the student refers to "that", "it", or earlier messages, use the conversation below for context`;
