...
export default function LearnPage() {
  ...
  const askTutor = async (query: string) => {
    ...
    try {
      ...
      setAiResponse(data.response || "I'm having trouble right now. Try again!");
          ...
          <div className="animate-page-in space-y-4">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="font-serif font-bold text-lg">Ask Your AI Tutor</h2>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {QUICK_ASKS.map((q) => (
                  <button
                    key={q}
                    onClick={() => { setAiQuery(q); askTutor(q); }}
            ...
            <div className="rounded-3xl p-4" style={{ background: "rgba(255,255,255,0.95)", border: "1px solid rgba(0,0,0,0.06)" }}>
              <p className="text-xs font-semibold mb-2" style={{ color: "#9E9EB0" }}>Type your question:</p>
              <div className="flex gap-2">
                <input
                  ...
                  onKeyDown={(e) => e.key === "Enter" && askTutor(aiQuery)}
            ...
            {/* Loading */}
            {aiLoading && (
              <div className="animate-page-in rounded-2xl p-4" style={{ background: "#EDE7F6" }}>
            ...
            {aiResponse && !aiLoading && (
              <div
                ref={responseRef}
                className="animate-bounce-in rounded-2xl p-5"
                style={{ background: "white", border: "2px solid #CE93D8", boxShadow: "0 4px 20px rgba(123,31,162,0.1)" }}
              >
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-lg">🤖</span>
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: "#EDE7F6", color: "#7B1FA2" }}>
                    AI Tutor
                  </span>
                </div>
            ...
            <div className="rounded-2xl p-4" style={{ background: "#F3E5F5", border: "1px solid #E1BEE7" }}>
              <p className="text-xs" style={{ color: "#6A1B9A" }}>
                💡 <strong>Tip:</strong> The more specific your question, the better the answer! Try asking about things you saw in the lesson.
              </p>
            </div>
          </div>
        )}
